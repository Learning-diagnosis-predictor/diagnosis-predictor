def make_new_diag_cols(data):
    ...
    # data["New Diag.Specific Learning Disorder with Impairment in Reading - Consensus"] = data["Diag.Specific Learning Disorder with Impairment in Reading"]
    # data["New Diag.Specific Learning Disorder with Impairment in Mathematics - Consensus"] = data["Diag.Specific Learning Disorder with Impairment in Mathematics"]
    # data["New Diag.Intellectual Disability-Mild - Consensus"] = data["Diag.Borderline Intellectual Functioning"]
    # data["New Diag.Borderline Intellectual Functioning - Consensus"] = data["Diag.Intellectual Disability-Mild"]
    # data["New Diag.Specific Learning Disorder with Impairment in Written Expression - Consensus"] = data["Diag.Specific Learning Disorder with Impairment in Written Expression"]
    # data["New Diag.Processing Speed Deficit"] = (data["WISC,WISC_PSI"] < 85) 
    
    # Use consensus diagnosis instead of test-based diagnosis in this branch to test if using test-based diagnosis improves performance
    ...
    data["New Diag.Specific Learning Disorder with Impairment in Written Expression"] = data["Diag.Specific Learning Disorder with Impairment in Written Expression"] 
    data["New Diag.Processing Speed Deficit"] = (data["WISC,WISC_PSI"] < 85) 
